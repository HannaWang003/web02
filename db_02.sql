...
(11, '二手菸沒有安全劑量，只要有暴露，就會有危險，請問它會造成身體上哪些危害?', 0, 1),
(12, '1.增加罹患冠狀動脈心臟病及罹病死亡之風險。', 11, 0),
(13, '2.對孩子的的健康會產生許多影響，例如容易咳嗽或打噴嚏、罹患氣喘或讓症狀更嚴重、會因刺激耳咽管，感染中耳炎、肺功能較差、容易罹患呼吸道疾病等。', 11, 0),
(14, '3.孕婦吸入二手菸易造成流產、早產、胎盤早期剝離、子宮感染等疾病。', 11, 0),
(15, '4.長期的暴露會造成更嚴重的胸腔問題和過敏症，還會增加心臟病和肺癌的罹患率。', 11, 0),
(16, '5.以上皆是。', 11, 1);
...
(3, 'root', '1111', 'root@gmail.com'),
(6, 'mem', '1234', 'mem@gmail.com'),
(7, 'mem5678', '5678', 'mem5678@gmail.com');
