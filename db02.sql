...
(1, '你最常做什麼運動來促進健康體能呢?', 0, 6),
(2, '健走或爬樓梯、慢跑等較不受時間、場地限制的運動。', 1, 4),
...
(8, '增加罹患冠狀動脈心臟病及罹病死亡之風險。', 7, 1),
(9, '對孩子的的健康會產生許多影響，例如容易咳嗽或打噴嚏、罹患氣喘或讓症狀更嚴重、會因刺激耳咽管，感染中耳炎、肺功能較差、容易罹患呼吸道疾病等。', 7, 1),
...
(7, 'mem02', 'mem02', 'mem02@labor.gov.tw'),
(12, 'mem05', 'mem05', 'mem05@labor.gov.tw'),
(13, 'mem03', 'mem03', 'mem03@labor.gov.tw');
