...
<div id="tags">
    <div class="tag active" onclick="getArticle(this,1)">健康新知 </div>
    <div class="tag" onclick="getArticle(this,2)">菸害防治</div>
    <div class="tag" onclick="getArticle(this,3)">癌症防治</div>
    <div class="tag" onclick="getArticle(this,4)">慢性病防治</div>
</div>
<div id="article">
    <h2 id="tit">健康新知</h2>
    <section>
...
<script>
function getArticle(dom, type) {
    $('.tag').removeClass('active');
    $(dom).addClass('active');
    let text = $(dom).text();
    $('#tit').text(text);
    $.post('./api/get_section.php?do=news', {
        type
    }, (res) => {
